...
<html lang="es">
  <head>
    ...
    <meta name="author" content="Marwin Perdomo, Felianni Alvarado">
      ...
      <div class="login-box">
        ...
        <form class="login-form" name="formLogin" id="formLogin" action="">
          ...
          <div class="form-group">
            ...
            <input id="txtEmail" name="txtEmail" class="form-control" type="email" placeholder="Correo Electronico" autofocus>
          </div>
          <div class="form-group">
          ...
          <div class="form-group btn-container">
            <button type="submit" class="btn btn-info btn-block"><i class="fa fa-sign-in fa-lg fa-fw"></i>INICIAR SESIÓN</button>
          </div>
        </form>
